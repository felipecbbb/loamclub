...
export const Card = ({
  ...
  <motion.div
    ...
    className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-2 border-[var(--color-olive)] p-2 md:p-6 bg-[var(--color-olive)] rounded-[30px] shadow-2xl"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl bg-[var(--color-cream)] md:rounded-2xl md:p-4">
      {children}
    </div>
  </motion.div>
);
